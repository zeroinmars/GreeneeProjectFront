  ...
  return(
    <Container fixed sx={{border:"1px solid black", p:"20px", mt:"2%"}}>
      <Stack spacing={2} alignItems="stretch">
        <TextField error={inputUserChar.job===""?true:false} label="직업" name="job" value={inputUserChar.job} onChange={(e)=>{setInputUserChar({...inputUserChar, job:e.target.value})}}></TextField>
